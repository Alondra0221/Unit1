...
namespace GRAFOS
{
    public class GRAFO
    {
        ...
        {
            visitados3.Add(final);

            for(int i = 0; i < visitados3.Count; i++)
            {
                if (visitados3[i].data == inicio.data)
                {
                    print_path();
                }
        ...
        private void search( VERTEX point)
        {
            ...
            for (int i=0; i<edges.Count; i++)
            {
                ...
                if (edges[i].vertex_final.data == point.data)
                {
        ...
        private void print_path()
        {
            ...
            for (int j = visitados3.Count - 1; j >= 0; j--) 
            {
                Console.Write(visitados3[j].data + " ");
